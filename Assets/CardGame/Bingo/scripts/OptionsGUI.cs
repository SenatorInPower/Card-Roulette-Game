...
namespace Bingo
{
    public class OptionsGUI : MonoBehaviour
    {
        ...
        void SetGameInfo()
        {
            GameMNG.Instance.NumberOfCards = /*(int)_sliderNumCards.value*/GameMNG.MAX_VALUE_NUMBER_OF_CARDS;
            GameMNG.Instance.NumberOfBalls = /*(int)_sliderNumBalls.value*/GameMNG.MAX_VALUE_NUMBER_OF_BALLS;
