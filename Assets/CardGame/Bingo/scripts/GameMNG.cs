...
namespace Bingo
{
    public class GameMNG : MonoBehaviour
    {
        ...
        const int CreditCostPerGame = 19;
        ...
        public TextMeshProUGUI CreditsText, ScoreText, BetText;
        ...
        void Start()
        {
            _onStart = false;
            _isFirstRound = true;
            _credits = PlayerPrefs.GetInt("Money"); 
            _score = _bet = 0;

            CreditsText.text = /*CreditAtTheBegin*/_credits.ToString();
        ...
        {
            return Mathf.RoundToInt(betValue * points*2 / 50);
        }
        ...
        {
            PlayerPrefs.SetInt("Money", _credits + newIngresss);
            _credits = PlayerPrefs.GetInt("Money");
        ...
        public void IncreaseBet()
        {
            ...
            int limitToBet = _credits - (BetStep+1);
            if (toBet > 1000)
                _bet = 1000;
